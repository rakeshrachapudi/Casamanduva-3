...
const WhatsAppButton = () => {
  ...
  const sendWhatsAppMessage = (messageType) => {
    const messages = {
      'Free Consultation': 'Hi CASAMANDUVA! I would like to schedule a free consultation for my interior design project.',
      'Get Quote': 'Hi CASAMANDUVA! I would like to get a quote for my interior design project.',
    ...
    const message = encodeURIComponent(messages[messageType] || 'Hi CASAMANDUVA! I need help with interior design.');
    ...
    <>
      <div className={`whatsapp-menu ${isMenuOpen ? 'active' : ''}`}>
        <div className="menu-header">
          <p className="menu-title">How can we help?</p>
          <p className="menu-subtitle">Click to start a conversation</p>
        </div>
