...
const Estimator = () => {
  ...
  const calculateEstimate = () => {
    ...
    selectedRooms.forEach((room) => {
      const roomKey = Object.keys(ROOM_PRICES).find((key) => room.includes(key) || key.includes(room)) || room;
  ...
  const openWhatsApp = () => {
    const message = encodeURIComponent(
      `Hi CASAMANDUVA! I used your estimator and got a quote of ₹${estimate?.grandTotal?.toLocaleString('en-IN')} for my ${BHK_DATA[selectedBHK].name} (${selectedPackage} package). I'd like to discuss this further.`
    );
              ...
              {estimate && (
                <>
                  ...
                  <p className="estimate-note">
                    * This is an approximate estimate. Final quote may vary based on site conditions, material choices, and customizations.
                  </p>
