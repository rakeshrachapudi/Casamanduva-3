...
const themes = [
  {
    ...
    category: "Minimalist",
    description:
      "Clean lines, natural materials, and serene spaces inspired by Japanese design principles.",
    image:
      "https://images.unsplash.com/photo-1545083036-b175dd155a1d?w=600&h=400&fit=crop",
  },
  {
    id: 2,
    ...
    category: "Luxury",
    description:
      "Sophisticated marble, rich textures, and timeless Italian craftsmanship.",
    image:
  ...
  },
  {
    ...
    description:
      "Sleek aesthetics, functional design, and understated luxury for modern living.",
    image:
  ...
  },
  {
    ...
    description:
      "Rich colors, intricate patterns, and cultural elements celebrating Indian artistry.",
    image:
  ...
  },
  {
    ...
    category: "Cozy",
    description:
      "Warm textures, soft lighting, and comfortable spaces for the ultimate hygge experience.",
    image:
  ...
  },
  {
    ...
    category: "Urban",
    description:
      "Raw materials, exposed elements, and urban sophistication for contemporary spaces.",
    image:
...
const processSteps = [
  {
    ...
    title: "Consultation",
    description:
      "Free initial meeting to understand your vision, requirements, and budget.",
  },
  {
    number: "02",
    title: "Design",
    description:
      "3D visualization and detailed design plans tailored to your space.",
  },
  {
    number: "03",
    title: "Execution",
    description:
      "Professional execution with premium materials and skilled craftsmen.",
  },
  {
    number: "04",
    title: "Delivery",
    description: "Final walkthrough and handover of your dream space.",
  },
];
...
const Home = () => {
  const homeSchema = {
    ...
    description:
      "Transform your home with luxury interior design services. 1BHK, 2BHK, 3BHK packages available.",
        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <AnimatedSection animation="fadeUp" delay={0.4}>
              <h1>
                Curated Spaces.{" "}
                <span className="text-gold">Elevated Living.</span>
              </h1>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fadeUp" delay={0.6}>
              <p className="hero-subtitle">
                ...
                From cozy 1BHK apartments to luxurious villas, we bring your
                vision to life.
              </p>
            </AnimatedSection>
        ...
        <div className="container">
          <AnimatedSection className="section-header">
            ...
            <h2 className="section-title">
              Design That Speaks To <span className="text-gold">Your Soul</span>
            </h2>
          </AnimatedSection>
          ...
          <div className="philosophy-grid">
            ...
            >
              ...
              <p>
                We create spaces that transcend trends, focusing on enduring
                beauty and sophisticated design.
              </p>
            </AnimatedSection>
            <AnimatedSection
              className="philosophy-item"
            ...
            >
              ...
              <p>
                Every element serves a purpose while contributing to the overall
                aesthetic harmony.
              </p>
            </AnimatedSection>
            <AnimatedSection
            ...
            >
              ...
              <p>
                Your personality, lifestyle, and dreams are woven into every
      ...
      >
        <div className="container">
          <AnimatedSection className="section-header">
            ...
            <h2 className="section-title">
              Explore Our <span className="text-gold">Signature Styles</span>
            </h2>
          </AnimatedSection>
            ...
            {themes.map((theme, index) => (
              ...
              >
                ...
                <div className="theme-content">
                  ...
                  <Link to="/services" className="theme-link">
                    Learn More →
                  </Link>
                </div>
              </AnimatedSection>
      ...
      <section className="cta-section">
        <div className="container">
          <AnimatedSection className="cta-content">
            ...
            <p>
              Get a free estimate for your 1BHK, 2BHK, or 3BHK interior design
              project
            </p>
            <Link to="/estimator" className="btn btn-primary btn-lg">
              Get Free Estimate
